<x-app-layout>
	<x-slot name="title">Carrinho | Cafuné</x-slot>
	...
	<div class="flex justify-center items-center relative min-h-screen bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
		...
		<div class="justify-center relative min-h-screen bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900">
			<div class="py-12">
